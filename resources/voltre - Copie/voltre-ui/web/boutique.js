const boutiqueManager = {
    ...
    init() {
        ...
        $('.boutique-close-btn').on('click', () => {
            fetch(`https://voltre-ui/boutique:close`, { method: 'POST' });
        });
    ...
    loadItems(category) {
        ...
        fetch(`https://voltre-ui/boutique:getItems`, {
            method: 'POST',
    ...
    loadUniqueVehicles() {
        fetch(`https://voltre-ui/getUniqueVehicles`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' }
        });
    },
    ...
    showItemDetail(item) {
        ...
        $('#detail-preview-btn').on('click', () => {
            fetch(`https://voltre-ui/boutique:preview`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    showUniqueVehicleDetail(vehicle) {
        ...
        $('#detail-buy-btn').on('click', () => {
            fetch(`https://voltre-ui/buyUniqueVehicle`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    startPreview(uniqueVeh) {
        ...
        $('.rotate-left').off('click').on('click', () => {
            fetch(`https://voltre-ui/boutique:rotate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    stopPreview() {
        ...
        fetch(`https://voltre-ui/boutique:stopPreview`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ direction: 'right' })
        });
    ...
    spinCase(caseItem) {
        fetch(`https://voltre-ui/boutique:openCase`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
