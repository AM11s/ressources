...
-- RegisterNetEvent("Voltre:removeInventoryWeapon")
-- AddEventHandler("Voltre:removeInventoryWeapon", function(WeaponName)
--     local src = source
...
--     local source = source
--     TriggerClientEvent("voltre:inv:load", source, xPlayer)
-- end)
...
-- ESX.RegisterServerCallback('voltre:inv:getClotheByNameAndType', function(source, cb, type,name)
--     local src = source
--     local xPlayer = ESX.GetPlayerFromId(src)
...
-- ESX.RegisterServerCallback('voltre:inv:getClotheEquiped', function(source, cb)
--     local src = source
--     local xPlayer = ESX.GetPlayerFromId(src)
...
-- ESX.RegisterServerCallback("voltre:inv:getPlayerInventory", function(source, cb, target, offline)
...
-- ESX.RegisterServerCallback("voltre:inv:getPlayerInventoryOffline", function(source, cb, idunique)
...
-- voltre.InitPrint("Inventory UI loaded")