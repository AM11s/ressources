...
--     elseif category == 'packs' then
--         TriggerServerEvent('voltre:server:BuyPack', item.name)
--     end
--     cb('ok')
-- end)
...
-- RegisterNetEvent('voltre:boutique:newCoinsAmount')
-- AddEventHandler('voltre:boutique:newCoinsAmount', function()
--     if isOpen then
--         ESX.TriggerServerCallback('sBoutique:getPoints', function(coins, fidelity)
--             SendNUIMessage({
--                 type = 'boutique:updateUserInfo',
...
--     local vehicles = exports["voltre-core"]:getUniqueVeh()
...
--     TriggerServerEvent('voltre:boutique:boughtUniqueVeh', data.vehicleId)
--     cb({ success = true })
-- end)
