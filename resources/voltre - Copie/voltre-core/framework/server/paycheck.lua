...
-- 					stateVip = nil
-- 					local stateVip = exports["voltre-core"]:GetVIP(xPlayer.identifier)
...
--         end
-- 		local AmountSalary = exports["voltre-core"]:GetVIP(xPlayer.identifier) == true and xPlayer.job.grade_salary*2 or xPlayer.job.grade_salary
