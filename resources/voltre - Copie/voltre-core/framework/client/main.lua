...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	TriggerServerEvent('voltre:cache:requestVersion')
end)

RegisterNetEvent('voltre:cache:versionChanged')
AddEventHandler('voltre:cache:versionChanged', function(version)
...
AddEventHandler('playerSpawned', function(spawn, isFirstSpawn)
	...
	TriggerServerEvent("voltre:esx:loadname", GetPlayerName(PlayerId()))
...
AddEventHandler('Voltre:skinchanger:loadDefaultModel', function() isLoadoutLoaded = false end)
function ESX.getIsDead() return isDead end
exports("playerIsDead", ESX.getIsDead)

AddEventHandler('Voltre:skinchanger:modelLoaded', function()
	voltre.fct.waitPlayerLoaded()
...
AddEventHandler('Voltre:showHud', function(value)
	disableUi = value
end)
...
Citizen.CreateThread(LPH_NO_VIRTUALIZE(function()
	while true do
		...
		TriggerServerEvent("voltre:esx:updateplaytime")
	end
end))
