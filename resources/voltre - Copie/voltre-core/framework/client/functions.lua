...
function ESX.ShowNotification(msg, title, subtitle)
	-- local VoltreUIStart = false
	-- if GetResourceState("voltre-ui") == "started" then
	-- 	VoltreUIStart = true
	-- end
	-- if VoltreUIStart then
	-- 	local success, result, result2 = pcall(function()
	-- 		if VoltreInventory.isOpen then
	-- 			return true, false
	-- 		elseif exports["voltre-ui"]:isInInterface() ~= false then
	-- 			return false, true
	-- 		else
	-- 			return false, false
	-- 		end
	...
	-- 		exports["voltre-ui"]:NotificationNUI(msg)
	-- 	else
	...
	local success, error = pcall(function()
		...
		if VoltreInventory.isOpen then
			TriggerEvent("inventory:sendMessage", msg, icon)
		elseif voltreuiStart and exports["voltre-ui"]:isInInterface() ~= false then
			exports["voltre-ui"]:NotificationNUI(msg)
		elseif voltre.modules.notifications.initialized then
...
function ESX.ShowMessage(msg)
	if voltre.modules.notifications.initialized then
...
function ESX.ShowAccept(msg, result)
	...
	--print("voltre.modules.notifications.initialized: " .. tostring(voltre.modules.notifications.initialized))
