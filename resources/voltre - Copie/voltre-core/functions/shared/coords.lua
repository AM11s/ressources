voltre.fct.GenerateRandomCoordAroundPoint = function(baseCoords, radius)
    local attempts = 0
...
exports("GenerateRandomCoordAroundPoint", voltre.fct.GenerateRandomCoordAroundPoint)


voltre.fct.JsonCoordsToVect3 = function(pos)
