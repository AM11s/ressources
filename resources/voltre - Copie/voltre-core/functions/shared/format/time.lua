voltre.fct.format.SecondsToStringClock = function(seconds)
...
voltre.fct.format.SecondsToDetailedString = function(seconds)
...
voltre.fct.format.SecondsToClock = function(seconds)
	if seconds == -1 then
		return {0,0,0}
	end
    local timerValue = {}
