voltre.fct.input = LPH_NO_VIRTUALIZE(function(TextEntry, isAdvanced, table, button)
    local input = nil
    ...
    if isAdvanced and table then
        ...
        input = exports['voltre-core']:Input(inputData, resourceName)
    else
        input = exports['voltre-core']:Input({
            title = TextEntry,
            fields = {
                {
                    type = "input",
...
voltre.fct.input2 = LPH_NO_VIRTUALIZE(function(TextEntry, isAdvanced, table, button)
    local input = nil
    local resourceName = nil
    if type(isAdvanced) == "string" then
        resourceName = isAdvanced
...
voltre.fct.smallInput = LPH_NO_VIRTUALIZE(function(Title, Description)
    local input = exports['voltre-core']:Input({
        title = Title,
        fields = {
            {
                type = "input",
...
voltre.fct.inputCb = LPH_NO_VIRTUALIZE(function(title, cb)
    local input = exports['voltre-core']:Input({
        title = title,
        fields = {
            {
