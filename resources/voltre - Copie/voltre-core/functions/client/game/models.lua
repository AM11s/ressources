voltre.fct.game.RequestAndWaitModel = LPH_NO_VIRTUALIZE(function(modelName)
...
voltre.fct.game.handlePreviewEventEntity = LPH_NO_VIRTUALIZE(function(model, entity_type)
    local entity = nil
