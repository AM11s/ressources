voltre.fct.game.RequestAndWaitAnimDict = LPH_NO_VIRTUALIZE(function(dict)
...
voltre.fct.game.startAnimAction = LPH_NO_VIRTUALIZE(function(lib, anim)
	voltre.fct.game.RequestAndWaitAnimDict(lib)
	TaskPlayAnim(plyPed, lib, anim, 8.0, 1.0, -1, 49, 0, false, false, false)
	RemoveAnimDict(lib)
end)

voltre.fct.game.PlayToggleEmote = LPH_NO_VIRTUALIZE(function(e, cb)
