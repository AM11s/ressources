...
voltre.fct.game.GetCoordsInFrontOfCam = LPH_NO_VIRTUALIZE(function(...)   
	local unpack = table.unpack   
	local coords,direction = GetGameplayCamCoord(), voltre.fct.math.RotationToDirection()   
	local inTable  = {...}   
	local retTable = {}    
...
voltre.fct.game.GetCoordsFromGamePlayCameraPointAtSynced = LPH_NO_VIRTUALIZE(function(ingoredEntity)
    local action = 0
    local distance = 1000
