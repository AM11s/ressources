...
voltre.fct.draw.AddLongString = function(txt)
    local maxLen = 100
...
voltre.fct.draw.Text = function(intFont, stirngText, floatScale, intPosX, intPosY, color, boolShadow, intAlign, addWarp)
	SetTextFont(intFont)
...
voltre.fct.draw.Text2 = function(text, scale, posX, posY, color)
	SetTextFont(0)
...
voltre.fct.draw.CenteredAnnouncement = function(text, Subtitle, timer)
