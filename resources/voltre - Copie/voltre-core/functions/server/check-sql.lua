voltre.fct.sql.CheckSocietyAndCreate = function(name, label)
...
voltre.fct.sql.CheckItemAndCreate = function(name, label)
...
voltre.fct.sql.CheckJobAndCreate = function(name, label)
...
voltre.fct.sql.CheckJobGradeAndCreate = function(name, label, rank, grade)
