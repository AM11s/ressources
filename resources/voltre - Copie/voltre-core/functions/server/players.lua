...
function voltre.fct.getIdentifiers(source)
    local identifiers = {
        fivem = nil,
        steam = nil,
        discord = nil,
...
function voltre.fct.BoostAndVip(identifier, source) 
    local sellBoostPct = 0
    pcall(function()
        sellBoostPct = exports["voltre-core"]:GetVIPSellBoost(identifier) or 0
    end)
...
exports("HowManyBoostVip", voltre.fct.BoostAndVip)