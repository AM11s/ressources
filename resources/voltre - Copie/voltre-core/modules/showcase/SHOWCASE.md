...
mysql -u USER -p -e "CREATE DATABASE voltre_showcase CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;"

# 3. Importer le schéma dans la nouvelle base
mysql -u USER -p voltre_showcase < showcase_schema.sql
```

Puis, dans le `server.cfg` de CE serveur **uniquement** :

```cfg
set mysql_connection_string "mysql://USER:PASSWORD@127.0.0.1/voltre_showcase?charset=utf8mb4"
setr voltre_showcase "true"
```
