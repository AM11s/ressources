...
RegisterNetEvent("voltre:sendcall", function()
...
RegisterServerEvent('Voltre:gouv:annonce')
AddEventHandler('Voltre:gouv:annonce', function(type)
	local _source = source
...
RegisterNetEvent('Voltre:gouv:vestaiaire:déposer')
AddEventHandler('Voltre:gouv:vestaiaire:déposer', function()
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.job.name == 'gouvernement' then
...
RegisterNetEvent('Voltre:gouv:vestaiaire:equipement')
AddEventHandler('Voltre:gouv:vestaiaire:equipement', function(item,price)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(source)
	if xPlayer.job.name == 'gouvernement' then
		for k,v in pairs(Config.Gouvernement.Services.weapons) do
