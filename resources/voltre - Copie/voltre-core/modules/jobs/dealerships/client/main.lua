...
CreateThread(function()
    ...
    for shopName, shop in pairs(Config.Dealerships.Shops) do
        ...
        voltre.data.markers.register("dealership_vendor_"..shopName, {
        ...
        voltre.data.markers.register("dealership_catalogue_"..shopName, {
            Position = shop.positions.catalogue,
            Public   = true,
            Action   = function() OpenTablet(shopName, 'public') end,
        })

        voltre.data.markers.register("dealership_wardrobe_"..shopName, {
