...
RegisterNetEvent('voltre:openMenuCustom-staff')
AddEventHandler('voltre:openMenuCustom-staff', function()
...
RegisterNetEvent('voltre:openMenuCustom')
AddEventHandler('voltre:openMenuCustom', function(jobname, joblabel, jobcoords, forstaff)
	if not lsMenuIsShowed then
		local playerPed = PlayerPedId()
				...
				elseif tempColorParts['mod'][colorPartIndex] == 'tireSmoke' then 
					RageUI.Button(smokeColorIndex[1]['label'] .. " [" .. smokeColorIndex[1]['index'] .. "]", nil, {}, true, {
						onSelected = function(Index)
							local smokeRedValue = tonumber(voltre.fct.input('Taux de rouge : '))
					...
					RageUI.Button(smokeColorIndex[2]['label'] .. " [" .. smokeColorIndex[2]['index'] .. "]", nil, {}, true, {
						onSelected = function(Index)
							local smokeGreenValue = tonumber(voltre.fct.input('Taux de vert : '))
					...
					RageUI.Button(smokeColorIndex[3]['label'] .. " [" .. smokeColorIndex[3]['index'] .. "]", nil, {}, true, {
						onSelected = function(Index)
							local smokeBlueValue = tonumber(voltre.fct.input('Taux de bleu : '))
...
AddEventHandler('fpwn_customs:canBill', function(amount, targetId)
	--TriggerServerEvent('Voltre:esx_billing:sendBill', targetId, society, "Mecano", amount)
	canClose = true
	terminatePurchase()
end)
