Citizen.CreateThread(function()
    ...
    TriggerServerEvent('Voltre:RetreiveIsDead')
end)

RegisterNetEvent('Voltre:PlayerIsDead', function()
...
RegisterNetEvent('Voltre:UpdateTableSignalEms', function(table)
    voltre.DebugPrint("recevie Signal EMS")
