-- ================================================================
-- VOLTRE REALTORS — Burglary (client)
-- ================================================================
...
AddEventHandler("realtor:burglary:tryUse", function(itemName)
    ...
    ESX.TriggerServerCallback("realtor:burglary:start", function(res)
        ...
        local pcallOk, pcallErr = pcall(function()
            exports["voltre-core"]:closeInventory()
        end)
        if not pcallOk then
...
local function burgEnterProperty(propData)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerServerEvent("voltre:properties:SetBucket", "solo", propData.bucketID)
...
local function burgExitProperty()
    ...
    if voltre and voltre.data and voltre.data.markers then
        voltre.data.markers.unregister("burglaryCoffre")
        voltre.data.markers.unregister("burglaryExit")
    end
    ...
    ESX.TriggerServerCallback("realtor:burglary:finish", function(res)
        ...
        if payload.success and res.sessionId then
            ...
            Citizen.CreateThread(function()
                ...
                if not (voltre and voltre.data and voltre.data.markers) then return end
                ...
                voltre.data.markers.register("burglaryCoffre", {
                ...
                voltre.data.markers.register("burglaryExit", {
                    Position = vector3(
