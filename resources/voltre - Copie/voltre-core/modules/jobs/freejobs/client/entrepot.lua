...
local function StartEntrepotJob()
    ...
    TriggerEvent('Voltre:skinchanger:getSkin', function(skin)
        TriggerEvent('Voltre:skinchanger:loadClothes', skin, cfgE.Tenue)
    end)
    ...
    SpawnMarchandise()
    TriggerServerEvent("Voltre:jobs:startActivity")
    WorkingCariste()
end
...
local function CollectEntrepotPay()
    ...
    TriggerServerEvent("Voltre:jobs:verifyJob", 2, trizomik)
    CleanupEntrepot()
end
...
function CleanupEntrepot()
    ...
    ESX.TriggerServerCallback('Voltre:esx_skin:getPlayerSkin', function(skin, jobSkin)
        ...
        TriggerEvent('Voltre:skinchanger:loadDefaultModel', isMale, function()
            ESX.TriggerServerCallback('Voltre:esx_skin:getPlayerSkin', function(skin2)
                TriggerEvent('Voltre:skinchanger:loadSkin', skin2)
