    ...
    for k, v in pairs(extrasCFG) do
        if type(v) == 'table' then
            for k2, v2 in pairs(v) do
                voltre.data.markers.register(("extras_menu-%s-%s"):format(k, k2), {
                    Position = v2,
                    Public = false,
                    Job = k,
                    Blip = false,
            ...
            voltre.data.markers.register("extras_menu-"..k, {
                Position = v,
                Public = false,
                Job = k,
                Blip = false,
...
RegisterNetEvent("voltre:client:openExtrasMenu")
AddEventHandler("voltre:client:openExtrasMenu", openExtrasMenu)