...
-- RegisterNetEvent('voltre:reciveNewPolitique', function(name, value)
--     if SocietyList[name] ~= nil then
--         SocietyList[name].politique = value
--     end
-- end)

-- RegisterNetEvent('Voltre:updateSalary', function(value)
--     SalaryData = value
-- end)

-- RegisterNetEvent('Voltre:updateTaxes', function(value)
--     taxesData = value
-- end)
...
--                         onSelected = function()
--                             local result = voltre.fct.input('Montant :', false, 9000000, "number")
--                             if (result) then 
--                                 TriggerServerEvent('Voltre:blanchiment', result)
--                             end
--                         end
--                     })
...
--                     onSelected = function()
--                         ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
...
--                     onSelected = function()
--                         ESX.TriggerServerCallback("Voltre:GetMemberOfSociety", function(result, result2) 
--                             employeeList = result
--                             myGradeList = result2
...
--                     onSelected = function()
--                         local newname = voltre.fct.input("Nouveau nom pour votre entreprise :")
...
--                     onSelected = function()
--                         local newname = voltre.fct.input("Votre annonce")
--                         TriggerServerEvent("Voltre:Annonce", newname)
--                         --society.label = newname
--                     end
--                 })]]
--             end
...
--                             TriggerServerEvent("voltre:properties:deleteProperties", v)
--                             RageUI.GoBack()
--                             Wait(1000)
--                             ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
--                                 ListProprieties = result
...
--                 onSelected = function()
--                     TriggerServerEvent("voltre:properties:deleteProperties", SelectedProprieties)
--                     RageUI.GoBack()
--                     Wait(1000)
--                     ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
--                         ListProprieties = result
...
--                     onSelected = function()
--                         TriggerServerEvent("voltre:properties:virerOwnerProperties", SelectedProprieties)
--                         RageUI.GoBack()
--                         Wait(1000)
--                         ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
--                             ListProprieties = result
...
--                     end,
--                     onSelected = function()
--                         TriggerServerEvent("voltre:properties:PlayerBuyPropeties", SelectedProprieties, GetPlayerServerId(closestPlayer))
--                         RageUI.GoBack()
--                         Wait(1000)
--                         ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
--                             ListProprieties = result
...
--                     onSelected = function()
--                         TriggerServerEvent("voltre:properties:PlayerBuyPropeties", SelectedProprieties)
--                         RageUI.GoBack()
--                         Wait(1000)
--                         ESX.TriggerServerCallback("voltre:properties:GetProperties", function(result) 
--                             ListProprieties = result
...
--                 onSelected = function()
--                     newname = voltre.fct.input("Nouveau nom de l'entreprise ?")
...
--                                 v = true
--                                 TriggerServerEvent("Voltre:EditPolitique", k, society.data.politique[k])
--                             end,
...
--                         onSelected = function()
--                             SocietyHistoRecherche = string.lower(voltre.fct.input("Que voulez vous chercher ?"))
--                         end
--                     })
--                 end
...
--                     onSelected = function()
--                         local newValue = voltre.fct.input("Nouveau Smic :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateSalary", "Mensuel", newValue, "min")
--                     end
--                 })
...
--                         local newValue = voltre.fct.input("Nouveau Smic :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateSalary", "Pour 30 Min", newValue, "min")
--                     end
--                 })
--                 RageUI.Button("Montant max pour les primes", nil, {RightLabel = "Actuellement: ~y~"..SalaryData["Primes"].max.."$~s~"}, true, {
--                     onSelected = function()
--                         local newValue = voltre.fct.input("Nouveau montant max pour les primes :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateSalary", "Primes", newValue, "max")
--                     end
--                 })
--                 RageUI.Line()
--                 RageUI.Button("Changer les taxes des retraits de compte", nil, {RightLabel = "Actuellement: ~y~"..taxesData.retrait.."%~s~"}, true, {
--                     onSelected = function()
--                         local newValue = voltre.fct.input("Nouveau montant :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateTaxes", "retrait", newValue)
--                     end
--                 })
...
--                         local newValue = voltre.fct.input("Nouveau montant :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateTaxes", "gains", newValue)
--                     end
--                 })
...
--                         local newValue = voltre.fct.input("Nouveau montant :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateTaxes", "salaire", newValue)
--                     end
--                 })
...
--                         local newValue = voltre.fct.input("Nouveau montant :")
--                         if not newValue then return end
--                         TriggerServerEvent("Voltre:gouv:updateTaxes", "tva", newValue)
--                     end
--                 })
--             end
--         end)
...
--                             --v = true
--                             --TriggerServerEvent("Voltre:EditPolitique", k, SocietyList[ESX.PlayerData.job.name].data.politique[k])
--                         end,
--                         onUnChecked = function()
...
--                     onSelected = function()
--                         RechercheSocietyMembreList = string.lower(voltre.fct.input("Nom Prenom/Pseudo/Id unique/Identifier a rechercher"))
--                     end
--                 })
...
--                     onSelected = function()
--                         local salaire = voltre.fct.input('Montant :', false, 9000000, "number")
