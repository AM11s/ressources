...
RegisterNetEvent("voltre:client:copy", function(txt)
    Copy(txt)
end)
...
RegisterNetEvent("voltre:client:openUrl", function(url)
    openUrl(url)
end)
...
voltre.InitPrint('^2Clipboard module loaded^7')
