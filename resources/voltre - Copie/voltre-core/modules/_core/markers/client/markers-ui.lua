...
function SetupMarkerInteraction()
    Citizen.CreateThread(function()
        ...
        local success, error = pcall(function()
            for k,v in pairs(Config.ClothingShop.List) do
                ...
                Add3DInteraction({
                    ...
                    Action = function()
                        -- exports["voltre-ui"]:openMenu("clothes")
            ...
            for k,v in pairs(Config.AccessoriesShop.List) do
                ...
                Add3DInteraction({
                    ...
                    Action = function()
                        --exports["voltre-ui"]:openMenu("accesories")
            ...
            for k, store in pairs(tattooStores) do
                Add3DInteraction({
                    ...
                    Action = function()
                        ...
                        exports["voltre-core"]:OpenShop("tattoo", store.Type)
                    end,
                    maxDistance = 5.0,
                    key = "E",
                    blip = {
        ...
        if not success then
            voltre.DebugPrint("^1[ERROR] in markers-ui.lua: " .. error)
        end
    end)
