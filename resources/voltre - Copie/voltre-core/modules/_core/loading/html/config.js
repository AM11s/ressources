...
window.LOADING_CONFIG = {
    ...
    socials: [
        { icon: 'fa-brands fa-discord', label: 'osnium FA' },
        { icon: 'fa-brands fa-tiktok',  label: '@osniumfa' },
    ],

    // Playlist musicale (chemins relatifs au dossier html/)
    music: [
        { label: 'Fresnes',                        author: 'Brulux', src: 'audio/brulux_fresnes.mp3' },
        ...
        patchnotes: [
            {
                ...
                changes: [
                    ...
                    { type: 'changed', text: 'Style enter phase aligné avec l\'identité visuelle Voltre' },
        ...
        team: [
            {
                ...
                name: 'osnium FA',
                avatar: 'img/logo.png',
                description: 'Fondateur et gestionnaire du projet.',
                badge: 'FOUNDER',
            },
            {
                role: 'Développeur',
