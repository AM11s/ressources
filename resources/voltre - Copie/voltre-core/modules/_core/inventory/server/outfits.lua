...
ESX.RegisterServerCallback('voltre:outfits:create', function(source, cb, pieces, outfitName)
...
ESX.RegisterServerCallback('voltre:outfits:disassemble', function(source, cb, outfitId)
...
ESX.RegisterServerCallback('voltre:outfits:equip', function(source, cb, outfitId)
...
--voltre.InitPrint("Inventory Outfits module loaded")
