...
function Crafting.GetRecipesForPlayer(playerId, recipes)
    ...
    for _, recipe in ipairs(recipes) do
        local r = {
            ...
            icon = recipe.icon or ("nui://voltre-cache/images/items/" .. recipe.item .. ".webp"),
            requirements = {},
        }
        ...
        for _, req in ipairs(recipe.requirements or {}) do
            ...
            table.insert(r.requirements, {
                ...
                icon = req.icon or ("nui://voltre-cache/images/items/" .. req.itemName .. ".webp"),
            })
        end
...
-- Server callbacks
ESX.RegisterServerCallback('voltre:crafting:getRecipes', function(source, cb, tableId)
    local recipes = {}
...
ESX.RegisterServerCallback('voltre:crafting:craft', function(source, cb, recipeId, tableId)
...
voltre.InitPrint("Inventory Crafting module loaded")
