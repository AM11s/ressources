...
function CreateGroundItem(coords, items, weapons, cash, dirtycash, accessories)
    ...
    TriggerClientEvent('voltre:groundItems:add', -1, id, GroundItems.items[id])
...
function DeleteGroundItem(id)
    ...
    -- Sync à tous les joueurs
    TriggerClientEvent('voltre:groundItems:remove', -1, id)
...
function AddItemToGroundItem(id, itemType, itemName, count, metadata)
    ...
    -- Sync à tous les joueurs
    TriggerClientEvent('voltre:groundItems:update', -1, id, groundItem)
...
ESX.RegisterServerCallback('voltre:groundItems:getData', function(source, cb, id)
    if not GroundItems.items[id] then
        cb(nil)
        return
    end
...
RegisterNetEvent('voltre:groundItems:deposit')
AddEventHandler('voltre:groundItems:deposit', function(id, itemType, itemName, count, metadata)
...
RegisterNetEvent('voltre:groundItems:withdraw')
AddEventHandler('voltre:groundItems:withdraw', function(id, itemType, itemName, count)
    ...
    elseif itemType == "accessory" then
        ...
        MySQL.Async.insert('INSERT INTO vclothes (identifier, type, name, label, data) VALUES (@identifier, @type, @name, @label, @data)', {
            ...
            if insertId and insertId > 0 then
                ...
                TriggerClientEvent("voltre:inventory:clearClothesCache", _source)
...
RegisterNetEvent('voltre:groundItems:checkAndDelete')
AddEventHandler('voltre:groundItems:checkAndDelete', function(id)
    if not GroundItems.items[id] then
        return
    end
...
AddEventHandler('esx:playerLoaded', function(playerId, xPlayer)
    TriggerClientEvent('voltre:groundItems:sync', playerId, GroundItems.items)
end)
