...
ESX.RegisterServerCallback('voltre:inventory:open', function(source, cb, id, invType, maxWeight)
...
RegisterNetEvent("voltre:inventory:close", function(cacheKey)
    local playerId = source
    InventoryStorage.Close(playerId, cacheKey)
end)

ESX.RegisterServerCallback('voltre:inventory:depositMoney', function(source, cb, cacheKey, amount, moneyType)
...
ESX.RegisterServerCallback('voltre:inventory:withdrawMoney', function(source, cb, cacheKey, amount, moneyType)
...
ESX.RegisterServerCallback('voltre:inventory:depositItem', function(source, cb, cacheKey, itemName, count, extra)
...
ESX.RegisterServerCallback('voltre:inventory:withdrawItem', function(source, cb, cacheKey, itemName, count, extra)
...
ESX.RegisterServerCallback('voltre:inventory:depositWeapon', function(source, cb, cacheKey, weaponName, metadata)
...
ESX.RegisterServerCallback('voltre:inventory:withdrawWeapon', function(source, cb, cacheKey, weaponName)
