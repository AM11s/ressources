/**
 * Voltre UI - Interactions Bridge
 * Pont de communication pour les dialogs Input et Confirm
 */

const VoltreInteractionsBridge = {
    iframe: null,
    initialized: false,
    originalZIndex: null,
    ...
    handleNUIMessage(data) {
        ...
        // } 
            ...
            if (this.activeComponents.size === 0) {
                fetch('https://voltre-core/contextMenuClosed', {
                    method: 'POST',
...
// Export global
window.VoltreInteractionsBridge = VoltreInteractionsBridge;
