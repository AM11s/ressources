...
function Appliers.mapPoint(slug, payload, label)
    ...
    TriggerClientEvent("voltre:studio:applyMapPoint", -1, slug, payload, label)
    return true
end
...
function Appliers.shop(slug, payload, label)
    ...
    TriggerClientEvent("voltre:studio:applyShop", -1, slug, payload, label)
    return true
end
...
if voltre and voltre.api and voltre.api.registerRoute then
    voltre.api.registerRoute("POST", "/studio/apply", function(body)
