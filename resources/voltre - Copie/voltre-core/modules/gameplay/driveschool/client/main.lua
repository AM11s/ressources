...
ESX = exports["voltre-core"]:getSharedObject()
...
function OpenDriveSchool()
    ...
    ESX.TriggerServerCallback('voltre:driveschool:getData', function(licenses, cash, bank)
        SendNUIMessage({
...
RegisterNUICallback('driveSchool:removeMoney', function(data, cb)
    ...
    TriggerServerEvent('voltre:driveschool:removeMoney', data.account, data.amount)
end)

RegisterNUICallback('driveSchool:theoryComplete', function(data, cb)
    cb({})
    if not data or not data.license then return end
    TriggerServerEvent('voltre:driveschool:giveLicense', data.license)
end)
...
function EndPractice()
    ...
    if passed then
        TriggerServerEvent('voltre:driveschool:giveLicense', practiceLicenseId)
    end
...
RegisterNetEvent('voltre:driveschool:updateData', function(licenses)
    SendNUIMessage({
