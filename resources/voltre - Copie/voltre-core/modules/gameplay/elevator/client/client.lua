...
RegisterNetEvent("voltre:ascenseur:recevie")
AddEventHandler("voltre:ascenseur:recevie", function(tablelist)
        ...
        for w,y in pairs(AscenseurList) do
            ...
            if dstCheck1 < 200 then
                ...
                for k,v in pairs(y.data) do
                    ...
                    if dstCheck < 2 then
                        voltre.fct.draw.Text3DBar(v.position.x, v.position.y, v.position.z, 'Appuyer sur [~y~E~s~] pour ouvrir l\'ascenseur')
...
Citizen.CreateThread(function()
    Wait(2000)
    TriggerServerEvent("voltre:initAscenseur")
end)