...
ESX.RegisterServerCallback("Voltre:repairshop:get", function(source, cb)
...
RegisterNetEvent("voltre:repair:get", function(weapon)
...
RegisterNetEvent("voltre:repair:weapon", function(weaponname, weapontype)
    ...
    pcall(function()
        local vipRepair = exports["voltre-core"]:GetVIPRepairTime(xPlayer.identifier)
