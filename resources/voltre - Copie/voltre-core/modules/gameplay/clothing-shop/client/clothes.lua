    ...
    while mainvet do 
        ...
        RageUI.IsVisible(mainvet, function()
            ...
            RageUI.Button("> Valider la tenue sans l'enregister", nil, {BackgroundColor = {R = 0, G = 255, B = 0, A = 255}, RightLabel = '~r~500 $'}, true, {
                onSelected = function()  
                    ESX.TriggerServerCallback("Voltre:cbmoneytenue", function(cb)
                        if cb == true then 
            ...
            RageUI.Button("> Valider la tenue et l'enregister", nil, {BackgroundColor = {R = 0, G = 255, B = 0, A = 255}, RightLabel = '~g~750 $'}, true, {
                onSelected = function()
                    local name = voltre.fct.input("Indiquer le nom de la tenue")
                    if name then 
                        local TempoSkin = {}
                        local ListVet = {
                            ["tshirt_1"] = true,
                        ...
                        TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                            ...
                            --TriggerServerEvent("Voltre:addtenueitem", name, TempoSkin)
                        end)
                       ...
                       --Vetement.Clothes["shoes_2"] =  Vetement.ChaussuresIndex2
                        --TriggerServerEvent("Voltre:addtenueitem", name, Vetement.Clothes)
                    end
                end
            })
                        ...
                        RageUI.List("Tenue "..v.label, {"Prendre sur soi", "Equiper", "Renommer", "Supprimer"}, Vetement.IndexGardeRobe, nil, {}, true, {
                            ...
                            onSelected = function(Index)
                                if Index == 1 then 
                                    ...
                                    --TriggerServerEvent("Voltre:tenuegarderobe", "equip", v.id)
                                elseif Index == 2 then 
                                    TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                                ...
                                elseif Index == 3 then
                                    local newname = voltre.fct.input("Nouveau nom")
                                    if newname then 
                ...
                for k, v in pairs(ClothesPlayer) do 
                    if v.equip ~= "n" then 
                        ...
                        RageUI.Button("Tenue "..v.label, nil, {RightLabel = "Déposer"}, true, {
                            onSelected = function()
                                TriggerServerEvent("Voltre:tenuegarderobe", "deposit", v.id)
                            end
                        })
                    else
        ...
        RageUI.IsVisible(tshirt, function()
            RageUI.Button("T-Shirt 0", nil, {}, true, {
                onActive = function()
                    ...
                    TriggerEvent('Voltre:skinchanger:change', 'tshirt_1', 0)
                    TriggerEvent('Voltre:skinchanger:change', 'tshirt_2', 0)
            ...
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 8) - 1, 1 do
                RageUI.Button("T-Shirt "..i, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'tshirt_1', i)
                        TriggerEvent('Voltre:skinchanger:change', 'tshirt_2', 0)
            ...
            for k, v in pairs(Vetement.TshirtList2) do
                RageUI.Button("Variation T-Shirt "..k, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'tshirt_2', k)
                    end
                })
            end
        end)
        ...
        RageUI.IsVisible(torse, function()
            RageUI.Button("Torse 0", nil, {}, true, {
                onActive = function()
                    ...
                    TriggerEvent('Voltre:skinchanger:change', 'torso_1', 0)
                    TriggerEvent('Voltre:skinchanger:change', 'torso_2', 0)
            ...
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 11) - 1, 1 do
                RageUI.Button("Torse "..i, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'torso_2', 0)
                        TriggerEvent('Voltre:skinchanger:change', 'torso_1', i)
            ...
            for k, v in pairs(Vetement.TorsoList2) do
                RageUI.Button("Variations Torse "..k, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'torso_2', k)
                    end
                })
            end
        end)
            ...
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 3) - 1, 1 do
                RageUI.Button("Bras "..i, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'arms', i)
                    end
                })
            end
        end)
        ...
        RageUI.IsVisible(calque, function()
            RageUI.Button("Calques 0", nil, {}, true, {
                onActive = function()
                    ...
                    TriggerEvent('Voltre:skinchanger:change', 'decals_1', 0)
                end
            })
            for k, v in pairs(Vetement.DecalsList) do
                RageUI.Button("Calques "..k, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'decals_1', k)
                    end
                })
            end
        end)
        ...
        RageUI.IsVisible(pantalon, function()
            RageUI.Button("Pantalon 0", nil, {}, true, {
                onActive = function()
                    TriggerEvent('Voltre:skinchanger:change', 'pants_1', 0)
                    TriggerEvent('Voltre:skinchanger:change', 'pants_2', 0)
            ...
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 4) - 1, 1 do
                RageUI.Button("Pantalon "..i, nil, {}, true, {
                    onActive = function()
                        TriggerEvent('Voltre:skinchanger:change', 'pants_1', i)
                        TriggerEvent('Voltre:skinchanger:change', 'pants_2', 0)
                        Vetement.PantalonList2 = {}
            ...
            for k, v in pairs(Vetement.PantalonList2) do 
                RageUI.Button("Variation Pantalon "..k, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'pants_2', k)
                    end
                })
            end
        end)
            ...
            for i = 0, GetNumberOfPedDrawableVariations(PlayerPedId(), 6) - 1, 1 do
                RageUI.Button("Chaussure "..i, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'shoes_1', i)
                        TriggerEvent('Voltre:skinchanger:change', 'shoes_2', 0)
            ...
            for k, v in pairs(Vetement.ChaussuresList2) do 
                RageUI.Button("Variation Chaussure "..k, nil, {}, true, {
                    onActive = function()
                        ...
                        TriggerEvent('Voltre:skinchanger:change', 'shoes_2', k)
                    end
                })
            end
        end)
