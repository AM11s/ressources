...
function OpenShopUI(storeConfig, options)
    ...
    -- Fetch player money
    ESX.TriggerServerCallback('voltre:shopui:getMoney', function(money)
        SendNUIMessage({
...
RegisterNUICallback('shopui:getRepairData', function(data, cb)
    ...
    ESX.TriggerServerCallback("Voltre:repairshop:get", function(repairs)
        local repairList = {}
...
RegisterNUICallback('shopui:repairWeapon', function(data, cb)
    ...
    TriggerServerEvent("voltre:repair:weapon", data.weaponName, data.ammoType)
...
RegisterNUICallback('shopui:repairPickup', function(data, cb)
    ...
    TriggerServerEvent("voltre:repair:get", data.weaponName)
...
RegisterNUICallback('shopui:buy', function(data, cb)
    ...
    if activeOrderContext and activeOrderContext.restaurantName then
        ESX.TriggerServerCallback('voltre:restaurant:placeOrder', function(success, result)
            if success then
                -- Refresh money
                ESX.TriggerServerCallback('voltre:shopui:getMoney', function(money)
    ...
    ESX.TriggerServerCallback('voltre:shopui:processTransaction', function(success, result)
        if success then
            SendNUIMessage({
                action = 'shopui:setMoney',
                data = result
...
voltre.InitPrint("ShopUI Client Module loaded")
