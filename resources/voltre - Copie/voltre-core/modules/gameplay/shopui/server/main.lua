...
ESX.RegisterServerCallback('voltre:shopui:processTransaction', function(source, cb, paymentType, cartArray)
...
ESX.RegisterServerCallback('voltre:shopui:getMoney', function(source, cb)
    local xPlayer = GetPlayer(source)
...
voltre.InitPrint("ShopUI Server Module loaded")
