...
function OpenPawnShop()
    ...
    ESX.TriggerServerCallback('voltre:pawnshop:getData', function(data)
        if not data then
...
-- ============================================================================
RegisterNetEvent("voltre:pawnshop:update")
AddEventHandler("voltre:pawnshop:update", function(data)
...
for _, eventName in ipairs({ "buyResult", "sellResult", "cancelResult", "collectResult" }) do
    RegisterNetEvent("voltre:pawnshop:" .. eventName)
    AddEventHandler("voltre:pawnshop:" .. eventName, function(result)
...
RegisterNUICallback("pawnshop:buy", function(data, cb)
    TriggerServerEvent("voltre:pawnshop:buy", data.listingId, data.quantity, data.paymentType, data.isNpc)
    cb("ok")
end)

RegisterNUICallback("pawnshop:sell", function(data, cb)
    TriggerServerEvent("voltre:pawnshop:sell", data.itemName, data.itemLabel, data.count, data.pricePerUnit)
    cb("ok")
end)

RegisterNUICallback("pawnshop:cancel", function(data, cb)
    TriggerServerEvent("voltre:pawnshop:cancel", data.listingId)
    cb("ok")
end)

RegisterNUICallback("pawnshop:collectAll", function(_, cb)
    TriggerServerEvent("voltre:pawnshop:collectAll")
    cb("ok")
end)