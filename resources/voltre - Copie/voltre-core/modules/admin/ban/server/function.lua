				...
				if result[1] ~= nil then
					MySQL.Async.fetchAll('SELECT * FROM account_info WHERE license = @license', {
						...
						if result2[1] ~= nil then
							...
							voltre.logs.send("Logs","Le joueur "..sourceplayername.."\nA ban le joueur "..targetplayername, "ban")
							if duree > 0 then
...
function ban(source,license,identifier,liveid,xblid,discord,playerip,targetplayername,sourceplayername,duree,reason,permanent)
	...
	voltre.logs.send("Ban","Le joueur : "..targetplayername.."\na était banni pour : "..reason.."\n pendant : "..duree.."","ban")
...
function deletebanned(license) 
	voltre.logs.send("Unban","La license : "..license.." a était débanni","unban")
	MySQL.Async.execute(
