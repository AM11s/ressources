...
function StaffHasPerm(perm)
    ...
    if Config.Admin.PermissionsGrade[perm] == nil then return false end
    ...
    if Config.GroupeGrade[ESX.PlayerData.group].grade >= Config.Admin.PermissionsGrade[perm] then
        return true
    else
        return false
    end
    ...
    if bool then
        --[[if group == "_dev" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueFonda.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueFonda.f)
                end
            end)
        elseif group == "superadmin" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueSuperAdmin.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueSuperAdmin.f)
                end
            end)
        elseif group == "admin" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueAdmin.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.StafftenueAdmin.f)
                end
            end)
        elseif group == "mod" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemod.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemod.f)
                end
            end)
        elseif group == "gerantlegal" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantlegal.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantlegal.f)
                end
            end)
        elseif group == "gerantillegal" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantillegal.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantillegal.f)
                end
            end)
        elseif group == "gerantstaff" then
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantstaff.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Stafftenuemodgerantstaff.f)
                end
            end)
        else]]
            TriggerEvent("Voltre:skinchanger:getSkin", function(skin)
                if skin.sex == 0 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Admin.StaffModeClothes.m)
                elseif skin.sex == 1 then
                    TriggerEvent("Voltre:skinchanger:loadClothes", skin, Config.Admin.StaffModeClothes.f)
                end
            end)
        --end
    else
            ...
            while isNameShown do
                ...
                for _, player in pairs(GetActivePlayers()) do
                    ...
                    if #(GetEntityCoords(plyPed, false) - GetEntityCoords(ped, false)) < 5000.0 then
                        ...
                        ESX.TriggerServerCallback('voltre:GetIDUnique', function(IDUnique) 
                            uniqueid = IDUnique 
                        end, player)
...
RegisterCommand("itemlist", function(source, args, rawCommand)
    if ESX.HasPermissions("liste_items_armes") then 
        ESX.TriggerServerCallback('voltre:getCoffre2', function(data, id)
            if data then
                local inventory = data
                inventory.weight = 0
                inventory.id = id
