...
CreateThread(function()
    local savedInfoPosition = GetResourceKvpString("voltre-core:"..ESX.Config("serverName")..":staff:info-position")
    if savedInfoPosition then
        nTable.InfoPosition = savedInfoPosition
    else
        nTable.InfoPosition = "middle-left"
        SetResourceKvp("voltre-core:"..ESX.Config("serverName")..":staff:info-position", "middle-left")
    end
end)
