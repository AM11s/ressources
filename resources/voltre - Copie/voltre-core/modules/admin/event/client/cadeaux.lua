        ...
        while true do
            ...
            if Vdist2(GetEntityCoords(PlayerPedId(), false), vector3(coords.x, coords.y,coords.z)) < 4.0 then
                if IsControlJustPressed(0, 51) then
                    TriggerServerEvent("voltre:noel:get", id)
                    break
                end
            end
            Wait(0)
...
RegisterNetEvent("voltre:noel:dropgift", function(coords, idgift, sleighCoords)
    GiftGetted = false
    ...
    Citizen.CreateThread(function()   
        ...
        while true do
            ...
            if distance < 5.0 then
                ...
                TriggerServerEvent("voltre:noel:giftdropped", idgift)
...
RegisterNetEvent("voltre:noel:deletegift", function()
