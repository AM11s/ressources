...
Citizen.CreateThread(LPH_NO_VIRTUALIZE(function()
    ...
    while not voltre.data.world.vehicles.loaded do
        Wait(100)
    end
...
RegisterNetEvent('worldvehicle:client:load', function(vehicles)
    for k,v in pairs(vehicles) do
        ...
        voltre.data.world.vehicles.list[v[5]] = {
            model = v[1],
            color = {r, g, b},
            pos = newPos,
            rotation = newRot,
...
RegisterNetEvent('worldvehicle:client:remove', function(id)
    local vehicleTable = voltre.data.world.vehicles.list[id]
    ...
    voltre.data.world.vehicles.list[id] = nil
...
RegisterNetEvent('worldvehicle:client:changeColor', function(id, color)
    ...
    voltre.data.world.vehicles.list[id].color = {r, g, b}
