-- ============================================================================
-- Voltre Doorlock — Éditeur in-game (/doorlock)
...
local function openManager()
    ...
    ESX.TriggerServerCallback('voltre_doorlock:getEditorList', function(list)
        if not list then
...
RegisterNUICallback('doorlock:create', function(data, cb)
    ESX.TriggerServerCallback('voltre_doorlock:create', function(ok, res)
        if ok then
...
RegisterNUICallback('doorlock:update', function(data, cb)
    ESX.TriggerServerCallback('voltre_doorlock:update', function(ok, err)
...
RegisterNUICallback('doorlock:delete', function(data, cb)
    ESX.TriggerServerCallback('voltre_doorlock:delete', function(ok, err)
