-- ============================================================================
-- Voltre Doorlock — Configuration partagée (client + serveur)
-- Système de verrouillage de portes natif voltre-core.
-- ============================================================================
...
-- Sons (xsound bundlé dans voltre-deps). nil = pas de son.
