...
-- ============================================================================
RegisterNetEvent("Voltre:gofast:missionResponse")
AddEventHandler("Voltre:gofast:missionResponse", function(data)
    if data.error then
...
function GF.PickupKeyExchange()
    ...
    TriggerServerEvent('voltre:gofast:pickupkey', mission.plate)
    ...
    TriggerServerEvent("Voltre:gofast:start")
...
function GF.DeliverySequence()
    ...
    TriggerServerEvent("Voltre:gofast:complete", engineHealth, plate)

    -- Wait for server result
    GF.awaitingResult = true
    local resultData = nil
    local handlerRef = AddEventHandler("Voltre:gofast:result", function(data)
        resultData = data
                ...
                while DoesEntityExist(hostilePed) do
                    ...
                    if deathPos then
                        ...
                        if distance <= 2.0 then
                            ...
                            TriggerServerEvent("voltre:gofast:deliveryped:takecargo", plate)
                            break
                        end
                    end
...
function GF.FailMission()
    ...
    TriggerServerEvent("Voltre:gofast:fail")
...
-- ============================================================================
RegisterNetEvent("Voltre:gofast:result")
AddEventHandler("Voltre:gofast:result", function(data)
...
-- ============================================================================
RegisterNetEvent("Voltre:gofast:betrayed")
AddEventHandler("Voltre:gofast:betrayed", function()
    GF.Cleanup()
...
-- ============================================================================
RegisterNetEvent("Voltre:gofast:ambush")
AddEventHandler("Voltre:gofast:ambush", function(data)
...
-- ============================================================================
RegisterNetEvent("Voltre:gofast:driveBy")
AddEventHandler("Voltre:gofast:driveBy", function(data) 
    ...
    voltre.DebugPrint("[GoFast] Drive-by: " .. vehicleCount .. " véhicules, " .. pedsPerVehicle .. " PNJ/véh — tier: " .. (data.tierLabel or "legacy"))
    ...
    Citizen.SetTimeout(180000, function()
        ...
        voltre.DebugPrint("[GoFast] Despawned drive-by (" .. vehicleCount .. " vehicles, " .. #spawnedPeds .. " peds)")
    end)
end)
        ...
        if dangerCfg and dangerCfg.dangerZone then
            ...
            if dist(pedCoords, center) < radius then
                ...
                if now - GF.lastDriveByTime > (dangerCfg.driveByCooldown or 300) then
                    TriggerServerEvent("Voltre:gofast:dangerZoneCheck")
