...
RegisterNetEvent('voltre:drugs:stop', function(type)
    local src = source
...
CreateThread(function() 
    local function fetch()
        ...
        MySQL.Async.fetchAll('SELECT * FROM drugs_circuits', {}, function(result)
            ...
            TriggerEvent("voltre:core:recevieload:DrugsCircuitCount", drugs_circuitscount)
            --Wait(10000)
    ...
    local function fetchLabo()
        MySQL.Async.fetchAll('SELECT * FROM illegal_laboratory', {}, function(result)
            ...
            TriggerEvent("voltre:core:recevieload:DrugsLaboratoryCount", illegal_laboratorycount)
            --Wait(10000)
    ...
    local function fetchSell()
        MySQL.Async.fetchAll('SELECT * FROM drugs_sell', {}, function(result)
            ...
            TriggerEvent("voltre:core:recevieload:DrugsSellsCount", drugssellcount)
            --Wait(10000)
...
ESX.RegisterServerCallback("voltre:getDrugsItems",function(source,cb)
    cb(drugs_circuits)
end)