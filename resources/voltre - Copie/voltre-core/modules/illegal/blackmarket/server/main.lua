...
Citizen.CreateThread(function()
    ...
    Wait(3000)
    print("[^4Voltre^7] Position BlackMarket Nord : "..ZoneInfoNorth.x.." "..ZoneInfoNorth.y.." "..ZoneInfoNorth.z.."")
    print("[^4Voltre^7] Position BlackMarket Sud : "..ZoneInfoSud.x.." "..ZoneInfoSud.y.." "..ZoneInfoSud.z.."")
end)
