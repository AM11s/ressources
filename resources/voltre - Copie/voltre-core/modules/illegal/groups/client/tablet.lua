...
function OpenIllegalTablet()
    ...
    ESX.TriggerServerCallback('voltre:tablet:getData', function(data)
        if data == nil then
            tabletOpen = false
...
RegisterNUICallback('illegalTablet:acceptMission', function(data, cb)
    TriggerServerEvent('voltre:tablet:acceptMission', data.missionId, data.missionType)
    Wait(300)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:claimMission', function(data, cb)
    TriggerServerEvent('voltre:tablet:claimMission', data.missionId, data.missionType)
    Wait(300)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:addGrade', function(data, cb)
    TriggerServerEvent('voltre:tablet:addGrade', data.label)
    Wait(500)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:removeGrade', function(data, cb)
    TriggerServerEvent('voltre:tablet:removeGrade', data.gradeName, data.gradePos)
    Wait(500)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:changePerms', function(data, cb)
    TriggerServerEvent('voltre:tablet:changePerms', data.permType, data.gradeKey, data.value)
    Wait(300)
    cb('ok')
end)

RegisterNUICallback('illegalTablet:changeMemberGrade', function(data, cb)
    TriggerServerEvent('voltre:tablet:changeMemberGrade', data.idunique, data.newGrade)
    Wait(500)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:kickMember', function(data, cb)
    TriggerServerEvent('voltre:tablet:kickMember', data.idunique)
    Wait(500)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:changeColor', function(data, cb)
    TriggerServerEvent('voltre:tablet:changeColor', data.color)
    Wait(300)
    ESX.TriggerServerCallback('voltre:tablet:getData', function(result)
        cb(result)
    end)
...
RegisterNUICallback('illegalTablet:fouiller', function(data, cb)
    ...
    if distance ~= -1 and distance <= 3.0 then
        ...
        if ESX.isHandsUp(targetPed) then
            ESX.TriggerServerCallback('voltre:fouiller', function(result, id)
                if result then
...
RegisterNUICallback('illegalTablet:facture', function(data, cb)
    ...
    local input = voltre.fct.input('Montant', false, 9000000, "number")
...
RegisterNUICallback('illegalTablet:validateGroup', function(data, cb)
    ESX.TriggerServerCallback('voltre:tablet:validateGroup', function(result)
        cb(result)
...
RegisterNUICallback('illegalTablet:createGroup', function(data, cb)
    TriggerServerEvent('voltre:tablet:createGroup', data.groupName, data.groupLabel)
    cb('ok')
end)

-- Event: Group created successfully, reopen tablet with gang data
RegisterNetEvent('voltre:tablet:groupCreated')
AddEventHandler('voltre:tablet:groupCreated', function()
...
RegisterNetEvent('voltre:tablet:levelUp')
AddEventHandler('voltre:tablet:levelUp', function(newLevel)
