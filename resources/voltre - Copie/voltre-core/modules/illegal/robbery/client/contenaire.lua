...
local function StartTakenConteneur()
    ...
    TriggerServerEvent('voltre:giveItem', type_item, type_loot, cb_togive, data)
              ...
              DrawMarkerCustom(v.pos)
                ...
                if dist < 1.2 then
                    ...
                    if IsControlJustPressed(0, 51) then
                        ...
                        TriggerServerEvent("voltre:conteneur:client:OpenC", v.id)
...
AddEventHandler("voltre:conteneur:client:OpenC", function(id, time)
    ...
    for k,v in pairs(Config.ContainerRobbery.Spawn_zones) do 
        ...
        if v.id == id then
            ...
            if time - v.last > Config.Interval then
                ...
                TriggerServerEvent("voltre:conteneur:server:take", v.id)
...
RegisterNetEvent("voltre:conteneur:client:take")

AddEventHandler("voltre:conteneur:client:take", function(ID, time)
...
RegisterNetEvent("voltre:conteneur:client:dril")

AddEventHandler("voltre:conteneur:client:dril", function()
