                ...
                lines = {
                    ...
                    },
                    {
                        ...
                        action = function() 
                            ...
                            if canAction then
                                TriggerServerEvent("voltre:labo:dryweed", id)
                    ...
                    },
                    {
                        ...
                        action = function() 
                            ...
                            if nbr > 0 then
                                ...
                                if canAction then
                                    TriggerServerEvent("voltre:labo:recoltedryweed", id)
                    ...
                    lines = {
                        {
                            ...
                            key = "E",
                            action = function()
                                if exports["voltre-core"]:GetAreCuting() then return end
                                ...
                                exports["voltre-core"]:OpenPropScene({
                                    ...
                                    onZoneAction = function(zoneId, actionId, actionType, toolId)
                                        if actionType == "hold_complete" and actionId == "cut" then
                                            ...
                                            exports["voltre-core"]:RemoveSceneZone(zoneId)

                                            TriggerServerEvent("voltre:labo:cutDriedHead", laboId, isFirstCut)
                                            isFirstCut = false

                                            --exports["voltre-core"]:AddResult({ id = "weed_head_raw", label = "Tête de weed", icon = "leaf", count = 1 })
                                            --exports["voltre-core"]:SendSceneNotification("Tête coupée !", "success")

                                            cutsRemaining = cutsRemaining - 1
                                            if cutsRemaining <= 0 then
                                                Citizen.SetTimeout(1500, function()
                                                    --exports["voltre-core"]:SendSceneNotification("Toutes les têtes sont coupées !", "success")
                        ...
                        },
                        {
                            ...
                            action = function()
                                ...
                                Citizen.CreateThread(function()
                                    ESX.TriggerServerCallback("voltre:labo:canCut", function(can)
                                        if can then
                                            local oldCam = GetFollowPedCamViewMode()
                                            SetFollowPedCamViewMode(4)
                                            DisableIdleCamera(true)
                                            voltre.DisplayHud("3dinteractions", false)
                                            exports["voltre-core"]:SetAreCuting(true)
                                            local saveCoords = GetEntityCoords(PlayerState.ped)
                                            ...
                                            TriggerServerEvent("voltre:labo:cutWeed", data.id)
                                            local hasObjective = GetCurrentObjectives()
                                            if hasObjective and hasObjective.id == "weed_processing" then
                                                SetObjectiveStep("package_buds")
                                            end

                                            exports["voltre-core"]:SetAreCuting(false)
                                            voltre.DisplayHud("3dinteractions", true)
                        ...
                        },
                        {
                            ...
                            action = function()
                                ...
                                local budImage = "nui://voltre-cache/images/props/bkr_prop_weed_bud_pruned_01a.webp"
                                ...
                                exports["voltre-core"]:OpenPropScene({
                                    ...
                                    onZoneDrop = function(zoneId, actionId, itemId, toolId, sourceType, sourceId)
                                        ...
                                        if total >= budsPerBag then
                                            ...
                                            exports["voltre-core"]:AddSceneProp({ id = bagPropId, model = "prop_custom_pooch_closed", offset = bagOffset })

                                            exports["voltre-core"]:UpdateZoneState(zoneId, "completed", false)
                                            --exports["voltre-core"]:AddResult({ id = "weed_pooch", label = "Pochon de weed", icon = "package", count = 1 })
                                            --exports["voltre-core"]:SendSceneNotification("Pochon rempli !", "success")

                                            bagsCompleted = bagsCompleted + 1
                                            if bagsCompleted >= numBags then
                                                Citizen.SetTimeout(1500, function()
                                                    exports["voltre-core"]:SendSceneNotification("Tout est conditionné !", "success")
                                                    local hasObjective = GetCurrentObjectives()
                                                    if hasObjective and hasObjective.id == "weed_processing" then
                                        ...
                                        elseif total >= 1 then
                                            ...
                                            exports["voltre-core"]:DeleteSceneProp(bagPropId)
                                            exports["voltre-core"]:AddSceneProp({ id = bagPropId, model = "sf_prop_sf_bag_weed_open_01b", offset = bagOffset })
                                            --exports["voltre-core"]:SendSceneNotification(string.format("Pochon %d/%d", total, budsPerBag), "info")
                                        end
                                    end,
...
RegisterNetEvent("voltre:labo:updateindrying", function(id, data)
    voltre.data.illegals.laboratories.list[id].treatmentequipment.indrying = data
    if voltre.data.illegals.laboratories.list[id].type == "weed" then
