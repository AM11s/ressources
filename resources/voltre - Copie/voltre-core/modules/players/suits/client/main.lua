RegisterNetEvent("Voltre:suit:equip", function(equip, suitname)
    if equip == "equip" then
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            TriggerEvent('Voltre:skinchanger:getSkin', function(skin)
                if skin.sex == 0 then
                    TriggerEvent('Voltre:skinchanger:loadClothes', skin, Config.Suits.allSuits[PlayerState.suit].skins)
                else
                    TriggerEvent('Voltre:skinchanger:loadClothes', skin, Config.Suits.allSuits[PlayerState.suit].skins2)
                end
            end)
            Wait(1000)
        end
