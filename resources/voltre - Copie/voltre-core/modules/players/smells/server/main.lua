...
ESX.RegisterServerCallback("voltre:smells:getPlayer", function(source, cb)
...
RegisterNetEvent("voltre:smells:updateSmell", function(data, data2)
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent("voltre:smells:setInSmellZone", function(name)
    local xPlayer = ESX.GetPlayerFromId(source)
