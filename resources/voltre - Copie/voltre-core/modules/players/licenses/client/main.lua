...
Citizen.CreateThread(function()
	Wait(4000)
	TriggerServerEvent("Voltre:licenses:askmylicenses")
end)

RegisterNetEvent("Voltre:licenses:recevie", function(result)
...
RegisterNetEvent("voltre:idcard:show", function(cardData)
