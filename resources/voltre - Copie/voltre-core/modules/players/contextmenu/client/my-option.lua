    ...
    local menuActions = {
        {
            ...
            Label = "La personne (...)",
            OnClick = function()
                local input = voltre.fct.input("Votre message :")
        ...
        },
        {
            ...
            OnClick = function()
                exports["voltre-core"]:copy(GetPlayerServerId(PlayerId()))
            end,
        },
        {
            user = "user", -- SI VOUS METTEZ "user" CELA VOUDRA DIRE QUE TOUTE PERSONNE AVEC LE GRADE USER POURRA VOIR LE BOUTON !
            ...
            OnClick = function()
                exports["voltre-core"]:copy(ESX.PlayerData.idunique)
            end,
        },
        {
            Type = "buttom",
    ...
    table.insert(menuActions, {
        ...
        Action = {
            ...
            },
            {
                ...
                KeepNuiFocus = true,
                function()
                    local item = voltre.fct.input("Nom de l'item")
            ...
            },]]
            {
                ...
                function() 
                    ...
                    -- local item = voltre.fct.input("Nom de l'item")
                    -- local amount = voltre.fct.input("Quantité d'item")
                    -- ExecuteCommand('giveitem ' ..id.." "..item.." "..amount)
                    local id = voltre.fct.smallInput("ID du joueur", "Vous pouvez mettre l'id 0 pour vous donnez l'item.")
            ...
            --{
                ...
                -- KeepNuiFocus = true,    
                --function()
                    --local playerId = voltre.fct.input("ID ?")
                    --if playerId then
