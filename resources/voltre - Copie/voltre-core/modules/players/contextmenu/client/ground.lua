    ...
    Action_Config = {
        Ground = {
            ...
            },
            {
                ...
                Label = "Poser un PNJ",
                OnClick = function() 
                    ped_model = voltre.fct.input("Modele du PNJ")
            ...
            },
            {
                ...
                OnClick = function()
                    obj_model = voltre.fct.input("Modele du props")
            ...
            },
            {
                ...
                OnClick = function()
                    veh_model = voltre.fct.input("Modele de la voiture")
                ...
                Action = {
                    ...
                    },                                 
                    {
                        ...
                        OnRelease = function(isChecked)  -- Action lors du changement d'état
                            ...
                            TriggerServerEvent("voltre:staff:activeBlips", isChecked)
                        end,
                    }, 
                    {
                        Type = "checkbox",
