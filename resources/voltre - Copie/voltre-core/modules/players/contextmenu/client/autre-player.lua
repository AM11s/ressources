...
function _Player()
    ...
    if cachedUID[srvid] then 
        ...
        local canTrigger = exports["voltre-core"]:actionCooldown('canTriggerCallBack_idunique_'..srvid, 2000)
        if canTrigger then
            ESX.TriggerServerCallback("voltre:GetIDUnique2", function(result) 
    ...
    Action_Config = {
        Player = {
            ...
            },
            {
                ...
                OnClick = function()
                    exports["voltre-core"]:copy(GetPlayerIdFromPed(LastEntityHit))
                end,
            },
            {
                Type = "buttom",
                ...
                OnClick = function()
                    if cachedUID[srvid] then 
                        exports["voltre-core"]:copy(cachedUID[srvid])
                    end
                end,
            },
            ...
            },
            {
                ...
                OnClick = function()
                    Citizen.Wait(500)
                    local animMsg = voltre.fct.input("Animation à suggérer")
            ...
            },
            {
                ...
                Action = {
                    ...
                    },
                    {
                        ...
                        function()
                            local id = GetPlayerIdFromPed(LastEntityHit)
                            local reason = voltre.fct.input("Entrez une raison")
                    ...
                    }, 
                    {
                        ...
                        function()
                            local id = GetPlayerIdFromPed(LastEntityHit)
                            local temps = voltre.fct.input("Entrez une durée (en heure)")
                            Wait(250)
                            local reason = voltre.fct.input("Entrez une raison")
