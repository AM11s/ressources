        ...
        Object = {
            {
                ...
                OnClick = function()
                    ...
                    exports["voltre-core"].DoTrashSearch(CurrentTrashEntity)
                end,
                Label = label,
            },
        },
    ...
    Action_Config = {
        Object = {
            ...
            },
            {
                ...
                OnClick = function()
                    exports["voltre-core"]:copy(LastEntityHit)
                end,
            },
            {
                Type = "buttom",
            ...
            },
            {
                ...
                Action = {
                    ...
                    function()
                        ...
                        exports["voltre-core"]:copy(objectName)
                    end,
                    },
                    {
                        ...
                        function()
                            ...
                            exports["voltre-core"]:copy(GetEntityModel(LastEntityHit))
                        end,
                    },
                    {
                        ...
                        function()
                            ...
                            exports["voltre-core"]:copy("vector3("..objectposition.x..", "..objectposition.y..", "..objectposition.z..")")
            ...
            },
             {
                ...
                Blocked = function()
                    ...
                    local groundItemId = exports['voltre-core']:GetGroundItemIdFromEntity(LastEntityHit)
                ...
                OnClick = function()
                    ...
                    if groundItemId then
                        exports['voltre-core']:PickupGroundItem(groundItemId)
                    end
                end,
            },
            {
                ...
                Action = {
                    
                    {
                        ...
                        function()
                            exports["voltre-core"]:copy(NetworkGetEntityOwner(LastEntityHit))
                        end,
                    },
                    {
                        ("Rotation : %s"):format(GetEntityRotation(LastEntityHit)),
                        function()
                            ...
                            exports["voltre-core"]:copy("vector3("..vec3.x..", "..vec3.y..", "..vec3.z..")")
                        end,
                    },
                    {
                        ("Type : %s"):format(GetEntityType(LastEntityHit)),
