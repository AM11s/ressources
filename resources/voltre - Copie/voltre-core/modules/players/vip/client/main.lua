CreateThread(function()
    ...
    TriggerServerEvent('voltre:vip:request')
end)

RegisterNetEvent('voltre:vip:sync', function(data)
    if not data then
    ...
    TriggerEvent('voltre:vip:updated', PlayerState.vip)
end)
...
RegisterNetEvent('voltre:updateVIP')
AddEventHandler('voltre:updateVIP', function(vip, viptype, viptime)
...
voltre.InitPrint('^2VIP module (client) loaded^7')
