...
RegisterNetEvent("voltre:esx:enter", function(bool)
    local xPlayer = ESX.GetPlayerFromId(source)
    xPlayer.setEnter(bool)
    if bool then
        voltre.fct.instance.Set(xPlayer.source, xPlayer.source, "CharSelector")
    else
        voltre.fct.instance.Set(xPlayer.source, 0, "CharSelector")
    end
end)
