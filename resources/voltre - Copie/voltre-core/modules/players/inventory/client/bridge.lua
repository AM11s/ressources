...
function PlayerInventoryClient.IsOpen()
    return VoltreInventory and VoltreInventory.isOpen or false
end
...
function PlayerInventoryClient.SetCanOpen(canOpen)
    if VoltreInventory then
        VoltreInventory.canOpen = canOpen
    end
end

function PlayerInventoryClient.CanOpen()
    return VoltreInventory and VoltreInventory.canOpen or false
end
...
function PlayerInventoryClient.GetEquippedAccessory(accessoryType)
    if VoltreInventory and VoltreInventory.equippedClothes then
        return VoltreInventory.equippedClothes[accessoryType]
    end
    return nil
end
...
function PlayerInventoryClient.GetAllEquippedAccessories()
    return VoltreInventory and VoltreInventory.equippedClothes or {}
end
...
voltre.InitPrint("Player Inventory Client Bridge loaded")
