...
ESX.RegisterServerCallback('Voltre:personalmenu:Admin_getUsergroup', function(source, cb)
...
ESX.RegisterServerCallback('Voltre:getFactures', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	local bills = {}
...
RegisterNetEvent('Voltre:personalmenu:Boss_promouvoirplayer', function(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_destituerplayer', function(target)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_recruterplayer', function(target, job)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_virerplayer', function(target)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_promouvoirplayer2', function(target)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_destituerplayer2', function(target)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_recruterplayer2', function(target, job2)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:personalmenu:Boss_virerplayer2', function(target)
    if target == -1 then return end
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterNetEvent('Voltre:leavejob',function(type)
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('Voltre:ChangeWeightInventory',function(sex, type, weight)
    local xPlayer = ESX.GetPlayerFromId(source)
    if (xPlayer) then
...
local isHandsup = {}
RegisterNetEvent('Voltre:handsup', function(value)
...
RegisterNetEvent("voltre:admin:desactivateInfiteMaxWeight", function()
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('Voltre:personalmenu:getHandsUp', function(source, cb, target)
...
--[[RegisterNetEvent('Voltre:Annonce', function(annonce)
	local xPlayer = ESX.GetPlayerFromId(source)
