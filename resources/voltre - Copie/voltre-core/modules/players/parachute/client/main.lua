...
RegisterNetEvent("voltre:setInParachute")
AddEventHandler("voltre:setInParachute", function(tinit, model)
...
RegisterNetEvent("voltre:removeParachute")
AddEventHandler("voltre:removeParachute", function()
    local weapon = GetHashKey("GADGET_PARACHUTE")
    local ped = GetPlayerPed(PlayerId())
