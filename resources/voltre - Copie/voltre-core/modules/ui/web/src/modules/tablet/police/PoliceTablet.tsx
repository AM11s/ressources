            ...
            <div className="police-brand-inner">
              {data.brand.logo ? (
                <img className="police-brand-logo" src={cacheImg(data.brand.logo)} alt={data.brand.name}
                  onError={(e) => { (e.target as HTMLImageElement).src = 'nui://voltre-cache/images/shopui/brands/lspd.png'; }} />
              ) : (
                <img className="police-brand-logo" src="nui://voltre-cache/images/shopui/brands/lspd.png" alt="Police" />
              )}
