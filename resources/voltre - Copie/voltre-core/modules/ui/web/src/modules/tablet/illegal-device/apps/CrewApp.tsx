    ...
    <div className="idev-crew-home">
      ...
      <div className="idev-bento">
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_missions.webp)' }}
        >
        ...
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_members.webp)' }}
        >
        ...
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_ranks.webp)' }}
        >
        ...
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_actions.webp)' }}
        >
        ...
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_market.webp)' }}
        >
        ...
        <button
          ...
          style={{ ['--cell-bg' as any]: 'url(nui://voltre-cache/images/illegaltablet/crew_territoires.webp)' }}
        >
