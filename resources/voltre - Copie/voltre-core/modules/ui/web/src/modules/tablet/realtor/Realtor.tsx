...
const MAP_IMAGE_URL = 'nui://voltre-cache/images/statellite-named.jpg';

// Sidebar brand (Dynasty 8 style)
const REALTOR_BRAND_BG = '#40e05f';
const REALTOR_BRAND_LOGO = 'https://api.voltre.fr/media/Dynasty8-GTAV-Logo_1777205175518.webp?v=1777205174255';
