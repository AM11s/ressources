...
-- Usage: exports["voltre-core"]:OpenCatalog(data)
-- data = {
--   title = "Titre",
...
--   },
--   imagePath = "nui://voltre-core/images/" (optional),
--   currency = "$" (optional, default "$"),
--   callbackEvent = "voltre:catalog:onBuy" -- server event triggered on purchase
-- }
...
function OpenCatalog(data)
    ...
    SendNUIMessage({
        ...
        data = {
            ...
            callbackEvent = data.callbackEvent or "voltre:catalog:onBuy",
        }
    })
end
