...
function InteractionsUI.Input(data, resource)
    ...
    if not hasFocus or resource ~= "voltre-core" then
        SetNuiFocus(false, false)
    end

    if hasInputFocus and resource == "voltre-core"  then
...
-- Compatibility wrapper for old voltre-ui exports
...
function VoltreInput(data, resourceName)
    return InteractionsUI.Input(data, resourceName)
end

function VoltreConfirm(data, resourceName)
    return InteractionsUI.Confirm(data, resourceName)
end
...
RegisterCommand('setfocus_voltrecore', function()
    SetNuiFocus(true, true)
end, false)

RegisterCommand('setunfocus_voltrecore', function()
    SetNuiFocus(false, false)
end, false)
