...
--     if VoltreInventory and VoltreInventory.isOpen then return end
...
--     ClosePauseMenu()
--     Wait(200)
--     TriggerServerEvent('voltre:player:disconnect')
--     cb('ok')
-- end)
...
--         TriggerEvent('voltre:tablet:open')
...
--         TriggerEvent('voltre:settings:open')
--     end
...
-- voltre.InitPrint("Pause Menu Loaded")
