...
function OpenBankUI()
    ...
    ESX.TriggerServerCallback('voltre:bank:getData', function(bankData)
...
RegisterNUICallback("bank:deposit", function(data, cb)
    ...
    TriggerServerEvent('Voltre:ActionBank', 'deposit', amount)
...
RegisterNUICallback("bank:withdraw", function(data, cb)
    ...
    TriggerServerEvent('Voltre:ActionBank', 'withdraw', amount)
...
RegisterNUICallback("bank:transfer", function(data, cb)
    ...
    TriggerServerEvent('Voltre:banque:sendVirement', {
        IBAN = data.iban,
        MONTANT = amount,
...
RegisterNUICallback("bank:acceptTransfer", function(data, cb)
    ...
    TriggerServerEvent('Voltre:RVirement', data.id)
...
RegisterNUICallback("bank:requestLoan", function(data, cb)
    ...
    TriggerServerEvent('Voltre:bank:requestLoan', {
        amount = amount,
...
RegisterNUICallback("bank:repayLoan", function(data, cb)
    ...
    TriggerServerEvent('Voltre:bank:repayLoan', {
        loanId = data.loanId,
...
RegisterNUICallback("bank:buyCard", function(data, cb)
    TriggerServerEvent('Voltre:bank:buyCard')
    cb("ok")
end)

RegisterNUICallback("bank:setPin", function(data, cb)
    if not data.pin then cb("error") return end
    TriggerServerEvent('Voltre:bank:setPin', { pin = tostring(data.pin) })
    cb("ok")
end)

RegisterNetEvent('voltre:bank:cardResult', function(data)
    SendBankNUI('bank:cardResult', data)
end)

RegisterNetEvent('voltre:bank:pinResult', function(data)
