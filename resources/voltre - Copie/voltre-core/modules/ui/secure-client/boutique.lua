...
function Boutique.Open()
    ...
    ESX.TriggerServerCallback('voltre:boutique:getData', function(data)
        SendNUIMessage({
...
RegisterNUICallback('boutique:getItems', function(data, cb)
    ...
    ESX.TriggerServerCallback('voltre:boutique:getItems', function(items)
        SendNUIMessage({
...
RegisterNUICallback('boutique:purchase', function(data, cb)
    ESX.TriggerServerCallback('voltre:boutique:purchase', function(result)
        SendNUIMessage({
...
RegisterNUICallback('boutique:openCrate', function(data, cb)
    ESX.TriggerServerCallback('voltre:boutique:openCrate', function(result)
        SendNUIMessage({
...
RegisterNUICallback('boutique:previewVehicle', function(data, cb)
    ...
    if not exports["voltre-core"]:GetSafeZone() then
...
function WeaponCustom.OpenForWeapon(weaponName)
    ...
    ESX.TriggerServerCallback('voltre:boutique:getPlayerWeapons', function(weapons)
        ...
        ESX.TriggerServerCallback('voltre:boutique:getCoins', function(coins)
            SendNUIMessage({
...
RegisterNUICallback('boutique:nightmarket:purchase', function(data, cb)
    ...
    ESX.TriggerServerCallback('voltre:nightmarket:purchase', function(result)
        SendNUIMessage({
...
RegisterNetEvent('voltre:nightmarket:started')
AddEventHandler('voltre:nightmarket:started', function()
    if Boutique.isOpen then
        SendNUIMessage({
...
RegisterNetEvent('voltre:nightmarket:stopped')
AddEventHandler('voltre:nightmarket:stopped', function()
    if Boutique.isOpen then
        SendNUIMessage({
...
RegisterNUICallback('weaponCustom:buyComponent', function(data, cb)
    ...
    ESX.TriggerServerCallback('voltre:boutique:buyWeaponComponent', function(result)
        SendNUIMessage({
...
if not voltre.modules.ui then
    voltre.modules.ui = {}
end
if not voltre.modules.ui.interactions then
    voltre.modules.ui.interactions = {}
end
voltre.modules.ui.interactions.Boutique = Boutique

-- Forward NUI messages from server to UI
RegisterNetEvent('voltre:boutique:nuiCallback')
AddEventHandler('voltre:boutique:nuiCallback', function(data)
    SendNUIMessage(data)
end)

voltre.InitPrint("Boutique Loaded successfully")
