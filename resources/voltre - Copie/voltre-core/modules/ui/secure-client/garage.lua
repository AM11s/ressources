...
RegisterNUICallback("garage:rename", function(data, cb)
    TriggerServerEvent('voltre:renameVehicle', data.owner, data.vehicle, data.label)
    cb("ok")
end)
...
RegisterNUICallback("garage:give", function(data, cb)
    ...
    TriggerServerEvent('Voltre:changevehicleowner', GetPlayerServerId(player), {
        plate = data.plate,
...
RegisterNUICallback("garage:assign", function(data, cb)
    ...
    TriggerServerEvent('Voltre:AttribuerVehicule', data.type, vehicleData)
    CloseGarageUI()
    cb("ok")
end)
