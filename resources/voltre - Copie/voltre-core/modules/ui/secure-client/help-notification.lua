-- ============================================================================
-- Voltre Help Notification feeder
--
...
-- Expose a voltre helper and a native export so other resources can use the
-- new UI without depending on ESX.
voltre = voltre or {}
voltre.ShowHelpNotification = ShowHelp
voltre.HideHelpNotification = Hide
...
if voltre and voltre.InitPrint then
    voltre.InitPrint("Help Notification HUD Loaded successfully")
end
