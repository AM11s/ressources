--[[
    ...
    Usage from other server scripts:
        exports['voltre-core']:StartPlayerObjectives(playerId, id, title, steps, options)
        exports['voltre-core']:SetPlayerObjectiveStep(playerId, stepIndexOrId)
        exports['voltre-core']:NextPlayerObjectiveStep(playerId)
        exports['voltre-core']:CompletePlayerObjectives(playerId, delay)
        exports['voltre-core']:StopPlayerObjectives(playerId)
]]
...
function StartPlayerObjectives(playerId, id, title, steps, options)
    ...
    TriggerClientEvent('voltre:objectives:start', playerId, id, title, steps, options)
end
...
function SetPlayerObjectiveStep(playerId, stepIndexOrId)
    ...
    TriggerClientEvent('voltre:objectives:setStep', playerId, stepIndexOrId)
end
...
function NextPlayerObjectiveStep(playerId)
    ...
    TriggerClientEvent('voltre:objectives:nextStep', playerId)
end
...
function CompletePlayerObjectives(playerId, delay)
    ...
    TriggerClientEvent('voltre:objectives:complete', playerId, delay)
end
...
function StopPlayerObjectives(playerId)
    PlayerObjectives[playerId] = nil
    TriggerClientEvent('voltre:objectives:stop', playerId)
end
