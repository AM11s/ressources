...
function SetObjectiveStep(stepIndexOrId)
    ...
    voltre.DebugPrint("SetObjectiveStep",newStep)
end
...
function CompleteObjectives(delay)
    ...
    voltre.DebugPrint("CompleteObjectives")
...
RegisterNetEvent('voltre:objectives:start')
AddEventHandler('voltre:objectives:start', function(id, title, steps, options)
    StartObjectives(id, title, steps, options)
end)

RegisterNetEvent('voltre:objectives:setStep')
AddEventHandler('voltre:objectives:setStep', function(id, stepIndexOrId)
    if id and currentObjectives and currentObjectives.id == id then
        SetObjectiveStep(stepIndexOrId)
    end
end)

RegisterNetEvent('voltre:objectives:nextStep')
AddEventHandler('voltre:objectives:nextStep', function()
    SetObjectiveStep(nil)
end)

RegisterNetEvent('voltre:objectives:complete')
AddEventHandler('voltre:objectives:complete', function(delay)
    CompleteObjectives(delay)
end)

RegisterNetEvent('voltre:objectives:stop')
AddEventHandler('voltre:objectives:stop', function()
    StopObjectives()
end)
