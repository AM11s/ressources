RegisterServerEvent('voltre:safezone:create')
AddEventHandler('voltre:safezone:create', function(data)
    ...
    TriggerClientEvent("voltre:safezone:init", -1, SaveData.SafeZone.List)
end) 

RegisterServerEvent('voltre:safezone:init')
AddEventHandler('voltre:safezone:init', function()
    while SaveData.SafeZone.Load == nil do
        Wait(10)
    end

    TriggerClientEvent("voltre:safezone:init", source, SaveData.SafeZone.List)
end)

RegisterServerEvent('voltre:safezone:delete')
AddEventHandler('voltre:safezone:delete', function(id)
...
voltre.InitPrint("SafeZone Module Initialized")