...
RegisterNetEvent('voltre:propInteract:open')
AddEventHandler('voltre:propInteract:open', function(config)
    OpenPropScene(config)
end)

RegisterNetEvent('voltre:propInteract:close')
AddEventHandler('voltre:propInteract:close', function()
    ClosePropScene()
end)
