...
if not Config.Optimization["screenshot-basic"].Enable then
    print("[VoltreCore] Config.Optimization[\"screenshot-basic\"].Enable=false : la ressource reste chargée (bundlée dans voltre-deps) mais ne sera pas appelée par les modules qui respectent ce flag.")
end