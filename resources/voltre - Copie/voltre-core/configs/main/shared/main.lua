...
-- @dashboardLabel: Logs de debug
-- @dashboardDescription: Active l'affichage des messages de debug dans la console du serveur. À désactiver en production pour alléger les logs.
-- @dashboardGroup: Debug
-- @dashboardWidget: boolean
Config.Print = {
    Debug = true,
    -- @dashboardHide
    -- Clé interne utilisée pour filtrer les logs — ne pas éditer depuis le dashboard.
    DebugKey = "e24975895620VNVBE",

    -- @dashboardLabel: Logs d'initialisation
    -- @dashboardDescription: Affiche les messages de démarrage des resources chargées par le core.
    -- @dashboardGroup: Debug
    -- @dashboardWidget: boolean
    Initializing = true,
    -- @dashboardHide
    InitializingKey = "e24975895620VNVBE",
}
