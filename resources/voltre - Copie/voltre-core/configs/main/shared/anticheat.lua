...
-- @dashboardDescription: Sélection des anticheats actifs. "others" est l'anticheat intégré Voltre, cumulable avec un anticheat externe (WaveShield).
...
Config.Anticheat = {
    votre_anticheat = { -- Tous sur false pour pas d'anticheat
        ...
        ["WaveShield"] = false,
        -- @dashboardLabel: Anticheat Voltre (intégré)
        -- @dashboardDescription: Active l'anticheat intégré de voltre-core. Peut être cumulé avec WaveShield.
        -- @dashboardGroup: Anticheat
        -- @dashboardWidget: boolean
        ["others"] = true,
    },
