Config.Markers = {
    ["kart"] = {
        ...
        Job2 = nil,
        Blip = {
            Name = voltre.getConvarKey("serverColor").."Activité~s~ | Karing",
            Sprite = 147,
            Display = 4,
            Scale = 0.8,
            Color = 5
    ...
    --[[["ikea"] = {
        ...
        Action = function()
            TriggerEvent('voltreopenNuiShop', "Ikea")
        end
    },]]
    ["lester"] = {
    ...
    --[[["AppleStore"] = {
        ...
        Action = function()
            TriggerEvent('voltreopenNuiShop', "AppleStore")
        end
    },
    ["pharmacy"] = {
        ...
        Blip = nil,
        Action = function()
            TriggerEvent('voltreopenNuiShop', "pharmacy")
        end
    },]]
    ["agentimmo_patron"] = {
    ...
    ["taxi_patron"] = {
        ...
        Job2 = nil,
        Blip = {
            Name = voltre.getConvarKey("serverColor").."Entreprise ~s~| Taxi",
            Sprite = 198,
            Display = 4,
            Scale = 0.75,
            Color = 5
...
if not IsDuplicityVersion() then
    Citizen.CreateThread(function()
        ...
        while voltre.data.markers == nil do Wait(100) end
        voltre.data.markers.register("gouvernement_citoyen", {
        ...
        voltre.data.markers.register("zonegf", {
