-- ============================================================================
-- voltre-deps
-- Bundle unique des dépendances runtime de la base Voltre V4.
...
author      'Voltre'
version "4.0.3"
description 'Voltre Core dependencies bundle (single-script).'

-- Démarré par voltre-loader AVANT voltre-core.
-- voltre-deps n'a PAS de dependency 'voltre-loader' car le loader le démarre
-- manuellement en première position via ExecuteCommand.
...
files {
    ...
    -- ox_lib (consumed via @voltre-deps/modules/ox_lib/init.lua)
    ...
    -- oxmysql (consumed via @voltre-deps/modules/oxmysql/lib/MySQL.lua)
    ...
    -- xsound UI (URLs $.post réécrites vers /voltre-deps/)
