...
-- voltre-deps bundle : oxmysql vit dans la ressource voltre-deps.
local oxmysql = exports['voltre-deps']
...
local function onReady(cb)
	-- voltre-deps bundle : check sur voltre-deps qui héberge oxmysql.
	while GetResourceState('voltre-deps') ~= 'started' do
		Wait(50)
	end
