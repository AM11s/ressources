...
lib = setmetatable({
    -- voltre-deps bundle : ox_lib vit dans la ressource voltre-deps sous modules/ox_lib/.
    name = 'voltre-deps',
    ...
    __newindex = function(self, key, fn)
        ...
        -- voltre-deps bundle : les sources internes ox_lib sont sous modules/ox_lib/resource/.
    ...
    __index = function(self, key)
        -- voltre-deps bundle : imports vivent sous modules/ox_lib/imports/
...
-- voltre-deps bundle : UI ox_lib vit sous modules/ox_lib/web/build/.
