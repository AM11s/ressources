-- ================================================================
-- Voltre Immo — lb-phone custom app (client)
-- ----------------------------------------------------------------
-- - Enregistre l'app dans lb-phone
-- - Bridge UI ↔ voltre-core (récupère les listings publics, pose
--   un waypoint sur la porte, etc.)
-- ================================================================

local IDENTIFIER = "voltre_immo"
...
local function addApp()
    ...
    if not ok then
        print("^1[VOLTRE-IMMO] AddCustomApp a échoué : " .. tostring(err) .. "^0")
    else
        print("^2[VOLTRE-IMMO] App enregistrée dans lb-phone^0")
    end
end
