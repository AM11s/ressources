...
local function TakeScreenshot(category, index, gender)
    ...
    TriggerServerEvent('voltre-imagemaker:saveScreenshot', {
...
local function StartGeneration(gender, specificCategory)
    ...
    if exports["voltre-core"] and exports["voltre-core"].DisplayHud then
        hudWasVisible = true
    ...
    if hudWasVisible and exports["voltre-core"] and exports["voltre-core"].DisplayHud then
