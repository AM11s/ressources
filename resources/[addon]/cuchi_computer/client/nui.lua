...
if Config.Computer.UseItem and Config.Computer.UseItem ~= "" then
    RegisterNetEvent("voltre:laptop:open", OpenUI)
end

RegisterNUICallback("exit", function(_, cb)
    StopAnimation(isLaptop)
    SetNuiFocus(false, false)
    exports["voltre-core"]:setChatCanOpen(true)
    UIOpen = false
...
RegisterNUICallback("purchaseUpgrade", function(data, cb)
    if data.upgrade and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:purchaseUpgrade", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("purchaseLabType", function(data, cb)
    if data.labType and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:purchaseLabType", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("hireEmployee", function(data, cb)
    if data.employee and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:hireEmployee", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("fireEmployee", function(data, cb)
    if data.employee and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:fireEmployee", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("payEmployee", function(data, cb)
    if data.employee and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:payEmployee", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("inviteMember", function(data, cb)
    if data.memberId and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:inviteMember", function(success, message, memberName)
            cb({
                success = success,
                message = message,
...
RegisterNUICallback("removeMember", function(data, cb)
    if data.memberId and data.laboratory then
        Framework.TriggerServerCallback("voltre:labo:removeMember", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("updateMemberPermissions", function(data, cb)
    ...
    if data.memberId and data.laboratory and data.permissions then
        Framework.TriggerServerCallback("voltre:labo:updateMemberPermissions", function(success, message)
            cb({
                success = success,
                message = message
            })
...
RegisterNUICallback("transferLabOwnership", function(data, cb)
    if data.newOwnerId and data.laboratoryId then
        ...
        Framework.TriggerServerCallback("voltre:labo:transferOwnership", function(success, message, newOwnerName)
            cb({
                success = success,
                message = message,
...
RegisterNUICallback("placeDeliveryOrder", function(data, cb)
    if data.items and data.address then
        Framework.TriggerServerCallback("voltre:labo:placeDeliveryOrder", function(success, message, orderId)
            cb({
                success = success,
                message = message,
                orderId = orderId
...
RegisterNUICallback("getBillingInfo", function(data, cb)
    if data.laboratoryId then
        Framework.TriggerServerCallback("voltre:labo:getBillingInfo", function(billingInfo)
            cb(billingInfo)
...
RegisterNUICallback("payLabBill", function(data, cb)
    if data.laboratoryId then
        Framework.TriggerServerCallback("voltre:labo:payBill", function(success, message)
            cb({
                success = success,
                message = message
            })
